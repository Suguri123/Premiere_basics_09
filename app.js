...
const courseData = {
    ...
    ch3: [
        ...
        { id: "3-4", title: "실습예제 — 시네마틱 인트로", duration: "6분", desc: "• 트랙매트 키 효과로 글자 속에 영상 넣기<br>• AI 배경클립+키프레임 애니메이션+전환효과를 활용한 시네마틱 인트로 완성", caption: "", resource: "", images: ["cinematic_intro_1.png", "cinematic_intro_2.png"], videoTutorialUrl: "https://youtu.be/pUGr5QZ7YIE", videoTutorialLabel: "동영상 보기 (트랙매트 키)" }
    ],
    ch4: [
        ...
        { id: "4-2", title: "Adobe Stock 무료 템플릿 가져오기", duration: "4분", desc: "라이브러리 패널에서 Adobe Stock 검색, 무료 필터, 라이브러리로 저장(다운로드) → 내 템플릿에 저장 → 프로젝트에 적용", caption: "무료 필터 체크 잊지 말기", resource: "Adobe Stock", image: "adobe_stock_usage_concept.png" },
        { id: "4-3", title: "외부 템플릿 사이트와 설치 방법", duration: "5분", desc: "• 무료 템플릿 사이트(Mixkit 등), .mogrt 파일 다운로드 → 그래픽 템플릿 패널에 설치<br>• 템플릿 또는 비디오 선택하고 Premiere로 검색", caption: "🔗 <a href='https://mixkit.co/' target='_blank' style='color: var(--secondary); text-decoration: underline; font-weight: 700;'>Mixkit 바로가기</a>", resource: "외부 템플릿", image: "external_template_usage_concept.png" },
        { id: "4-4", title: "생성형 확장으로 짧은 클립 늘리기", duration: "5분", desc: "도구메뉴에서 생성형 확장 도구 선택 → 타임라인에서 영상클립의 끝을 드래그 → AI가 비디오 2초, 오디오는 10초, 비디오+오디오는 2초까지 연장본 생성", caption: "부족한 1~2초는 AI에게", resource: "", image: "generative_extend_usage_concept.png" },
